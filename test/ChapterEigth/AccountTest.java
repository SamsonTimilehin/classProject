package ChapterEigth;

import Chapter_Eight.Account;
...
public class AccountTest {
        ...
        @Test
        void customerCannotWithdrawMoreThanHisBalance(){
            Account account1 = new Account("Jane", new BigDecimal("0.0"));
            account1.deposit(new BigDecimal(3500));


            assertThrows( IllegalArgumentException.class,()-> account1.withdraw(new BigDecimal(4000)));
        }
}
